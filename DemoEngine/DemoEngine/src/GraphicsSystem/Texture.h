...
namespace lge
{
	...
	enum class TextureName : unsigned int
	{
		...
		Rocks,
		ExampleNormalMap,
		ProceduralSurfaceSimple,
		ProceduralSurfaceMinimal,
		ProceduralSurfaceComplicated
	};
	...
	public:
		...
		// Load a texture from a Procedutex TextureBuffer
		Texture(const procedutex::util::TextureBuffer2d& image, TextureMapType textureMapType, TextureName newName);
		// Dtor
		~Texture();
