...
namespace lge
{
	...
	public:
		...
		// Factory for Textures. Automatically added
		static Texture* const Create(TextureName name, TextureMapType mapType, const procedutex::util::TextureBuffer2d& image, TextureFilterType filtering, TextureWrapType wrapping);
